...
First, download a distribution of the Fluxnova Platform. You can choose from different distributions for various application servers. In this tutorial, we will use the Apache Tomcat based distribution. Download it from [the download page](https://fluxnova.finos.org/download#download-other-menu).
