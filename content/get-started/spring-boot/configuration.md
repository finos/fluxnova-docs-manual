...
The full list of supported configuration parameters can be found [here]({{< relref "/user-guide/spring-boot-integration/configuration/#fluxnova-engine-properties" >}}).
