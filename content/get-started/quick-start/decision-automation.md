...
In this section, you'll learn how to add decision automation to your process by using [BPMN 2.0 *Business Rule Tasks*]({{< relref "/reference/bpmn20/tasks/business-rule-task/" >}}) and [DMN 1.3 Decision Tables]({{< relref "/reference/dmn/" >}}).
...
First, specify the input expressions for the DMN table. In this example, we'll decide whether a payment is approved based on the item name. Your rules can also make use of the FEEL Expression Language, JUEL or Script. If you like, you can [read more about Expressions in the DMN Engine]({{< relref "/user-guide/dmn-engine/expressions-and-scripts/" >}}).
