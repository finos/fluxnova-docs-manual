...
In some cases, we'll want to involve humans in our process. Move onto the next step to [learn how you can involve humans in your process]({{< relref "/get-started/quick-start/user-task/" >}}).
{{< /note >}}
