...
By default, the decision task always evaluates the latest decision definition with the specified key. To specify a different version of a decision, it is possible to define a binding with the Fluxnova custom attribute `decisionBinding`. The following values are allowed for the attribute `decisionBinding`:
...
To evaluate a referenced decision, the integration of the Fluxnova DMN engine is used. As a result, only [DMN 1.3] decisions can be evaluated with a decision task. There is no option to integrate with other rule engines.
...
<table class="table table-striped">
  <tr>
    <th>Attributes</th>
    <td>
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#decisionbinding" >}}">camunda:decisionBinding</a>,
            <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#decisiontenantid" >}}">camunda:decisionTenantId</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#decisionversion" >}}">camunda:decisionVersion</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#mapdecisionresult" >}}">camunda:mapDecisionResult</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#resultvariable" >}}">camunda:resultVariable</a>
    </td>
  </tr>
  <tr>
...
[DMN 1.3]: {{< relref "/reference/dmn/_index.md" >}}
