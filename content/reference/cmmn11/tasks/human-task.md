...
<table class="table table-striped">
  <tr>
    <th>Attributes</th>
    <td>
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#assignee" >}}">camunda:assignee</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#candidategroups" >}}">camunda:candidateGroups</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#candidateusers" >}}">camunda:candidateUsers</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#duedate" >}}">camunda:dueDate</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#formkey" >}}">camunda:formKey</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#priority" >}}">camunda:priority</a>
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-elements.md#tasklistener" >}}">camunda:taskListener</a>,
