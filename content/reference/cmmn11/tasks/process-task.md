...
By default, the process task creates a new process instance of the latest process definition with the specified key. To specify a different version of a process, it is possible to define a binding with the Fluxnova custom attribute `processBinding`. The following values are allowed for the attribute `processBinding`:
...
The Fluxnova custom extensions elements `in` and `out` allow to exchange variables between the process task (in a case instance) and the process instance that it creates: `in` elements of a process task map case variables to input variables of the launched process instance and `out` mappings of a process task map output variables of the process instance to case variables, e.g.,:
...
<table class="table table-striped">
  <tr>
    <th>Attributes</th>
    <td>
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#processbinding" >}}">camunda:processBinding</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#processtenantid" >}}">camunda:processTenantId</a>,
      <a href="{{< relref "/reference/cmmn11/custom-extensions/fluxnova-attributes.md#processversion" >}}">camunda:processVersion</a>
    </td>
  </tr>
  <tr>
