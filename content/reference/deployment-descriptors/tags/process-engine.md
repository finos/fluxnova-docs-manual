...
The process engine configuration can be placed in both [processes.xml]({{< relref "/reference/deployment-descriptors/descriptors/processes-xml.md" >}}) and the [bpm-platform.xml]({{< relref "/reference/deployment-descriptors/descriptors/bpm-platform-xml.md" >}}) files. If the process engine is configured in either or both of those files, it will be bootstrapped by the Fluxnova infrastructure and be made available through `BpmPlatform.getProcessEngineService().getProcessEngine("name of process engine")`.
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <p>
        <strong>Text Content:</strong>
        The fully qualified classname of the Process Engine Configuration class to be used for this process engine. The class must be a subclass of {{< javadocref page="org/finos/fluxnova/bpm/engine/impl/cfg/ProcessEngineConfigurationImpl.html" text="ProcessEngineConfigurationImpl" >}}".
      </p>
      <p>
        <strong>Default Value:</strong>
        {{< javadocref page="org/finos/fluxnova/bpm/engine/impl/cfg/StandaloneProcessEngineConfiguration.html" text="StandaloneProcessEngineConfiguration" >}}
      </p>
      <p>
  ...
  <tr>
    ...
    <td>
      ...
      <p>
        <strong>Text Content:</strong>
        The fully qualified classname of a process engine plugin. Must be an implementation of {{< javadocref page="org/finos/fluxnova/bpm/engine/impl/cfg/ProcessEnginePlugin.html" text="ProcessEnginePlugin" >}}
      </p>
    </td>
  </tr>
</table>
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      ...
      <p>
        ...
        <a href="{{< relref "/user-guide/process-engine/authorization-service.md#resources" >}}">
  ...
  <tr>
    ...
    <td>String</td>
    <td>
        Sets the value for process engine <a href="{{< relref "/user-guide/process-engine/database/database-configuration.md">}}">database schema creation</a>.
      <p>
  ...
  <tr id="enable-historic-instance-permissions">
    ...
    <td>
        ...
        <a href="{{< relref "/user-guide/process-engine/authorization-service.md#historic-instance-permissions" >}}">Historic Instance Permissions</a>
  ...
  <tr id="enforceSpecificVariablePermission">
    ...
    <td>Boolean</td>
    <td>
        If the value of this flag is set to <code>true</code>, the <a href="{{< relref "/user-guide/process-engine/authorization-service.md#default-read-variable-permissions" >}}">default permissions</a> to see/read variables are:
        <ul>
  ...
  <tr>
    ...
    <td>String</td>
    <td>
        Sets the <a href="{{< relref "/user-guide/process-engine/history/history-configuration.md#choose-a-history-level">}}">level of the process engine history</a>.
      <p>
  ...
  <tr id="historyRemovalTimeStrategy">
    ...
    <td>String</td>
    <td>
      Controls if and when the <a href="{{< relref "/user-guide/process-engine/history/history-cleanup.md#instance-removal-time">}}">removal time</a> of an historic instance is set.
      The default value is <code>end</code>.<br>
      Please also see the <a href="{{< relref "/reference/deployment-descriptors/tags/process-engine.md#historyCleanupStrategy">}}"><code>historyCleanupStrategy</code></a>
  ...
  <tr id="hostname">
    ...
    <td>
      ...
      {{< javadocref page="org/finos/fluxnova/bpm/engine/impl/history/event/HostnameProvider.html" text="HostnameProvider" >}} 
  ...
  <tr>
    ...
    <td>
        ...
        <p>
        <strong>Note</strong>: The <a href="{{<relref "/user-guide/process-engine/database/database-configuration.md#isolation-level-configuration" >}}">recommended transaction isolation level</a> that ensures the correct behaviour of the engine is <code>READ_COMMITTED</code>.
        </p>
        <strong>Values:</strong> <code>true</code>, <code>false</code> (Boolean).
    </td>
  </tr>
  <tr>
    ...
    <td>
      ...
      <p>
        Default is <code><strong>true</strong></code>, but this has to be disabled for some databases. See <a href="{{<relref "/user-guide/process-engine/database/database-configuration.md#jdbc-batch-processing" >}}">the user guide</a> for further details.
      </p>
    </td>
  </tr>
  <tr>
  ...
  <tr id="jobExecutorAcquireExclusiveOverProcessHierarchies">
    ...
    <td>
        ...
        <p>
        <p>
            See the <a href="{{< relref "/user-guide/process-engine/the-job-executor.md#exclusive-jobs-of-process-hierarchies" >}}">user guide</a> for more details.
        <p>
  ...
  <tr id="skipHistoryOptimisticLockingExceptions">
    ...
    <td>Boolean</td>
    <td>
        Controls if the engine will throw <a href="{{< relref "/user-guide/process-engine/transactions-in-processes.md#optimistic-locking-in-fluxnova" >}}">OptimisticLockingException</a>s on UPDATE or DELETE operations for historical data or not.
  ...
  <tr id="invocations-per-batch-job-by-batch-type">
    ...
    <td>
        ...
        Read more in the 
        <a href="{{< relref "/user-guide/process-engine/batch.md#configuration" >}}">User Guide</a>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>Boolean</td>
    <td>
      Sets if the incidents can be handled by <a href="{{< relref "/user-guide/process-engine/incidents.md#composite-incident-handlers" >}}"f>multiple</a> handlers for the same incident type.
      <p>
        Default value is <code>false</code>.
      </p>
      <p>
  ...
  <tr>
    ...
    <td>Boolean</td>
    <td>
        Sets if validation of types should be performed before JSON and XML deserialization. See <a href="{{< relref "/user-guide/security.md#variable-values-from-untrusted-sources" >}}">Security Instructions</a> for further information. Default value: <code>false</code>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>Boolean</td>
    <td>Set to <code>true</code>, to enable a <a href="{{< relref "/user-guide/process-engine/password-policy" >}}">password policy</a> for users that are managed by the engine. If a <a href="{{< relref "/user-guide/process-engine/password-policy/#customize-the-password-policy">}}">custom password policy</a> is configured, it will be enabled. Otherwise the <a href="{{< relref "/user-guide/process-engine/password-policy/#built-in-password-policy">}}">built-in password policy</a> is activated.
    </td>
  </tr>
  ...
  <tr id="webappsAuthenticationLoggingEnabled">
    ...
    <td>Boolean</td>
    <td>Set to <code>true</code> to enable authentication logging in the Fluxnova web apps (Cockpit, Tasklist, and Admin). When enabled, the Fluxnova web apps will produce log statements in the application log for each user initiated log in and log out event. The name of the logger is <code>org.finos.fluxnova.bpm.webapp</code>.
    </td>
  </tr>
  ...
  <tr>
    ...
    <td>
        ...
        <a href="{{< relref "/user-guide/process-engine/process-engine-api.md#query-maximum-results-limit">}}">User Guide</a>.
        <br><br>
  ...
  <tr id="dmnFeelCustomFunctionProviders">
    ...
    <td>
        ...
        Read more about it in the <a href="{{< relref "/user-guide/dmn-engine/feel/custom-functions.md" >}}">User Guide</a>.
    </td>
  </tr>
  ...
  <tr id="skipOutputMappingOnCanceledActivities">
    ...
    <td>
        ...
        <p>This flag is often used together with <a href="{{< relref "/reference/bpmn20/custom-extensions/extension-elements.md#erroreventdefinition" >}}">fluxnova:errorEventDefinition</a> extension elements on external service tasks.</p>
  ...
  <tr id="exception-codes">
    ...
    <td>Boolean</td>
    <td>
      Disables the entire <a href="{{< relref "/user-guide/process-engine/error-handling.md#exception-codes" >}}">exception error code feature</a>. No exception error codes are assigned.
       <p>
        Default value is <code>false</code>.
      </p>
      <p>
  ...
  <tr>
    ...
    <td>Boolean</td>
    <td>
      Disables the default implementation of {{< javadocref page="org/finos/fluxnova/bpm/engine/impl/errorcode/ExceptionCodeProvider.html" text="ExceptionCodeProvider" >}} which allows overriding the <a href="{{< relref "/user-guide/process-engine/error-handling.md#reserved-code-range" >}}">reserved exception codes</a>.
       <p>
        Default value is <code>false</code>.
      </p>
      <p>
  ...
  <tr>
    ...
    <td><code>{{< javadocref page="org/finos/fluxnova/bpm/engine/impl/errorcode/ExceptionCodeProvider.html" text="ExceptionCodeProvider" >}}</code></td>
    <td>
      ...
      <p>
        Read more in the <a href="{{< relref "/user-guide/process-engine/error-handling.md#register-a-custom-code-provider" >}}">User Guide</a>.
      </p>
    </td>
  </tr>
  <tr>
  ...
  <tr id="logEntriesPerSyncOperationLimit">
    ...
    meaning the number of new operation log entries from one API call can never exceed logEntriesPerSyncOperationLimit.</li>
      ...
      <p>
        ...
        <br>
        More information about security aspects of this configuration can be found in the <a href="{{< relref "/user-guide/security.md#user-operation-log-settings-for-synchronous-operations-affecting-multiple-entities" >}}">security guide</a>.
      </p>
      <p>
...
<table class="table table-striped">
  <tr id="historyCleanupStrategy">
    ...
    <td>String</td>
    <td>
      Controls which <a href="{{< relref "/user-guide/process-engine/history/history-cleanup.md">}}">History cleanup</a> strategy is used.
      The default value is <code>removalTimeBased</code>.<br>
      Please also see the <a href="{{< relref "/reference/deployment-descriptors/tags/process-engine.md#historyRemovalTimeStrategy">}}"><code>historyRemovalTimeStrategy</code></a> configuration parameter.<br><br>
  ...
  <tr>
    ...
    <td>String</td>
    <td><a href="{{< relref "/user-guide/process-engine/history/history-cleanup.md">}}">History cleanup</a> batch window start time for Mondays. Requires the same format as <code>historyCleanupBatchWindowStartTime</code>.
  ...
  <tr>
    ...
    <td>String</td>
    <td><a href="{{< relref "/user-guide/process-engine/history/history-cleanup.md">}}">History cleanup</a> batch window end time for Mondays. Requires the same format and follows the same logic
  ...
  <tr>
    ...
    <td>Activates metrics for history cleanup. Default value is <code>true</code>.
      ...
      <a href="{{<relref "/user-guide/process-engine/metrics.md#disable-reporting" >}}">general metrics collection is not disabled</a>.    
    </td>
  </tr>
  <tr id="history-cleanup-enabled">
    ...
    <td>
        ...
        For more details, please see <a href="{{<relref "/user-guide/process-engine/history/history-cleanup.md#cleanup-execution-participation-per-node" >}}">Cleanup Execution Participation per Node</a>
        in the User Guide.
    </td>
  </tr>
...
<table class="table table-striped">
  <tr>
    ...
    <td>String</td>
    <td>Defines acceptable values for the User, Group and Tenant IDs. Can be defined by using the standard <a href="https://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html">Java Regular Expression syntax</a>. Default value: <code>[a-zA-Z0-9]+|fluxnova-admin</code></td>
  </tr>
  <tr>
    <td><code>userResourceWhitelistPattern</code></td>
    <td>String</td>
    <td>Defines acceptable values for the User IDs. Can be defined by using the standard <a href="https://docs.oracle.com/javase/7/docs/api/java/util/regex/Pattern.html">Java Regular Expression syntax</a>. Default value: a custom general whitelist pattern or the default <code>[a-zA-Z0-9]+|fluxnova-admin</code> (if nothing is defined)</td>
  </tr>
  <tr>
...
These parameters define the keys at which the specified data can be retrieved from the Mapped Diagnostic Context (MDC). See [Logging]({{< relref "/user-guide/logging.md#process-data-context" >}}) for details.
