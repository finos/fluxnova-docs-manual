...
The deployment descriptors are XML configuration files which allow configuration of Fluxnova and declaratively specify the BPMN 2.0 deployments to the process engine.
