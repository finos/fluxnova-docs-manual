...
title: 'Fluxnova Forms Reference'
weight: 60
layout: "single"
...
menu:
  main:
    name: "Fluxnova Forms"
    identifier: "fluxnova-forms-ref"
    parent: "forms-ref"
    pre: "Forms created with the Fluxnova Modeler embeddable in Tasklist"
---
...
* **Text**: Either **Markdown** or **basic HTML** which will be rendered in the Form. Please note that dangerous HTML elements will not be rendered so to prevent the risk of cross-site scripting using Fluxnova Forms.
