...
The Form SDK itself does not provide any custom components or widgets. As such it also does not provide a date picker. However, you can integrate third party libraries providing such widgets or write one yourself (see [Custom JavaScript]({{< relref "/reference/forms/embedded-forms/javascript/_index.md" >}})).

{{< note >}}
Inside Fluxnova Tasklist, datepicker support is provided through Angular UI.
{{< /note >}}
...
(see [Custom JavaScript]({{< relref "/reference/forms/embedded-forms/javascript/_index.md" >}})):
