...
{{< note >}}
If an HTML control is not supported, you need to write [custom JavaScript]({{< relref "/reference/forms/embedded-forms/javascript/lifecycle.md#implementing-custom-fields" >}}).  
{{< /note >}}
...
The `cam-business-key` is aimed to be used on a free text input field in order to define a businessKey at the [start of a process](https://docs.fluxnova.finos.org/rest/fluxnova-bpm-platform/{{< minor-version >}}/process-definition/post-submit-form.md" ).  
...
See also: [Setting the business key using Javascript]({{< relref "/reference/forms/embedded-forms/javascript/generating-businesskey.md" >}})
