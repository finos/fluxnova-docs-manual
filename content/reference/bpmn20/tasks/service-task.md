...
It is also possible to invoke logic which is implemented in form of webservices. `camunda:connector` is an extension that allows calling REST/SOAP APIs directly from the workflow. For more information about using connectors, please see the corresponding [section]({{< relref "/user-guide/process-engine/connectors.md#use-connectors" >}}) of the [User Guide]({{< relref "/user-guide/_index.md" >}})
...
<table class="table table-striped">
  ...
  <tr>
    ...
    <td>
      <a href="{{< relref "/reference/bpmn20/custom-extensions/extension-elements.md#erroreventdefinition" >}}">camunda:errorEventDefinition</a>,
