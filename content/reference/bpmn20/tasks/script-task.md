...
Fluxnova should work with most of the JSR-223 compatible script engine implementations. We test integration for Groovy, JavaScript, JRuby and Jython. See the <a href="{{< relref "/introduction/third-party-libraries/_index.md#process-engine" >}}">Third Party Dependencies</a> section of the <a href="{{< relref "/user-guide/_index.md" >}}">User Guide</a> for more details.
...
[user-guide]: {{< relref "/user-guide/_index.md" >}}
