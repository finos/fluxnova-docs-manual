...
Double using a [custom data type]({{< relref "/user-guide/dmn-engine/data-types.md#implement-a-custom-data-type" >}}).
...
[output entry]: {{< relref "/reference/dmn/decision-table/rule.md#output-entry-conclusion" >}}
