...
Each DRG should have an unique id when it is [deployed] to Fluxnova.
...
It has a `href` attribute and the value starts with `#` followed by the [decision id]({{< relref "/reference/dmn/decision-table/_index.md#decision-id" >}}) of the required decision.
...
Note that an input data has no execution semantics and is ignored by the Fluxnova DMN engine.
...
Note that a knowledge source has no execution semantics and is ignored by the Fluxnova DMN engine.
...
[id]: {{< relref "/reference/dmn/decision-table/_index.md#decision-id" >}}
[name]: {{< relref "/reference/dmn/decision-table/_index.md#decision-name" >}}
