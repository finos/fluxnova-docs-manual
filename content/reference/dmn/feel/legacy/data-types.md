...
The Fluxnova DMN engine supports the following FEEL data types.
...
FEEL supports numeric types like integer. In the Fluxnova DMN engine the
...
FEEL supports date types. In the Fluxnova DMN engine the following date types
are available:
