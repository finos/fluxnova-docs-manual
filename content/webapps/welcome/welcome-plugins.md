...
In addition to the [configurable custom links]({{< relref "/webapps/welcome/configuration.md" >}}), plugins can be used to add functionality to the Welcome application. For further details about the concepts behind plugins, please read the [Cockpit plugins section]({{< relref "/webapps/cockpit/extend/plugins.md" >}}). Please note that the Welcome application just offers _frontend only_ plugins.
