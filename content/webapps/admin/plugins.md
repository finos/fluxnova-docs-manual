...
{{< note title="Plugin Compatibility" class="info" >}}
  Please note that the code of Admin plugins might need to be migrated when updating Fluxnova to a higher version (e.g. CSS styles).
{{< /note >}}
...
You can find examples of [Admin dashboard plugins here](https://github.com/finos/fluxnova-bpm-platform/tree/master/webapps/frontend/ui/admin/plugins/base/app/views/dashboard).
