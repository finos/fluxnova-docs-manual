...
custom frontend module. Tasklist shares the frontend module structure with [Cockpit Plugins]({{<relref "/webapps/cockpit/extend/plugins.md#structure-of-a-frontend-module" >}}).
