...
menu:
  main:
    ...
    pre: "A CSRF-Prevention Filter for the Fluxnova Web Applications"
---
...
```xml
  ...
  <filter>
    ...
    <filter-class>org.finos.fluxnova.bpm.webapp.impl.security.filter.CsrfPreventionFilter</filter-class>
    <init-param>
