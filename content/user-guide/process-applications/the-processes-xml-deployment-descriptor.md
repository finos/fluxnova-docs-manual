...
The default location of the processes.xml file is `META-INF/processes.xml`. Fluxnova will parse and process all processes.xml files on the classpath of a process application. Composite process applications (WAR / EAR) may carry multiple subdeployments providing a META-INF/processes.xml file.
...
xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  <process-engine name="my-engine">
    <configuration>org.finos.fluxnova.bpm.engine.impl.cfg.StandaloneInMemProcessEngineConfiguration</configuration>
  </process-engine>
