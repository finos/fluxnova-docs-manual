...
Note that for this to work, you need to define a {{< javadocref page="org/finos/fluxnova/bpm/engine/test/ProcessEngineRule.html" text="ProcessEngineRule" >}} bean in the Spring configuration (which is injected by auto-wiring in the example above).

```xml
<bean id="processEngineRule" class="org.finos.fluxnova.bpm.engine.test.ProcessEngineRule">
