...
If your class implements the `org.finos.fluxnova.bpm.engine.delegate.JavaDelegate` interface, you can access the BPMN model instance
...
If your class implements the `org.finos.fluxnova.bpm.engine.delegate.ExecutionListener` interface, you can access the BPMN model instance
...
If your class implements the `org.finos.fluxnova.bpm.engine.delegate.TaskListener` interface, you can access the BPMN model instance
