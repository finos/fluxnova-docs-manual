...
The Fluxnova DMN engine can be used as a library in a custom application. To achieve this,
add the `fluxnova-engine-dmn` artifact to the classpath of the application and then
...
page="?org/finos/fluxnova/bpm/dmn/engine/delegate/DmnDecisionTableEvaluationListener.html"
...
page="?org/finos/fluxnova/bpm/dmn/engine/spi/DmnEngineMetricCollector.html"
...
page="?org/finos/fluxnova/bpm/dmn/engine/delegate/DmnDecisionEvaluationListener.html"
...
The {{< javadocref
page="?org/finos/fluxnova/bpm/dmn/engine/impl/DefaultDmnEngineConfiguration.html"
...
page="?org/finos/fluxnova/bpm/dmn/engine/impl/spi/transform/DmnTransformer.html"
text="DMN transformer" >}} or configuring the {{< javadocref
page="?org/finos/fluxnova/bpm/dmn/engine/impl/transform/DefaultDmnTransformer.html"
text="default one" >}}.

### Register DMN Transform Listeners

The simplest customization is to provide a {{< javadocref
page="?org/finos/fluxnova/bpm/dmn/engine/impl/spi/transform/DmnTransformListener.html"
...
page="?org/finos/fluxnova/bpm/dmn/engine/impl/spi/transform/DmnElementTransformHandler.html"
...
javadocref page="?org/finos/fluxnova/bpm/model/dmn/instance/DecisionTable.html"
text="decision table" >}}.
...
To evaluate `JUEL` expressions, the DMN engine uses the {{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/impl/spi/el/ElProvider.html" text="ElProvider" >}} configured in the
...
To configure the `FEEL` engine used you can provide a custom {{< javadocref page="org/finos/fluxnova/bpm/dmn/feel/impl/FeelEngineFactory.html" text="FeelEngineFactory" >}}.
...
Script languages are resolved by the {{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/impl/spi/el/DmnScriptEngineResolver.html" text="DmnScriptEngineResolver" >}}. To customize the script engine resolving, provide an own implementation.
...
The DMN engine uses [SLF4J] as logging API. The `fluxnova-dmn-engine` artifact
