...
This page documents how Fluxnova Spin can be used together with the Scala FEEL Engine. Furthermore, 
...
capable of using Spin, if another component of Fluxnova (here, the FEEL Engine) 
supports its usage. 
