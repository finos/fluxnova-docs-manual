...
The Fluxnova DMN engine supports two expression languages out of the box:

- `JUEL`: A Fluxnova-maintained [implementation][juel] of the Java [Unified Expression Language][EL]
...
[Nashhorn]: https://www.oracle.com/technical-resources/articles/java/jf14-nashorn.html
