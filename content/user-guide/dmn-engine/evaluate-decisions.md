...
The DMN engine {{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/DmnEngine.html" text="interface" >}} exposes methods
for parsing and evaluating DMN Decisions.

# Parse Decisions

Decisions can be parsed from an `InputStream` or transformed from a {{< javadocref page="org/finos/fluxnova/bpm/model/dmn/DmnModelInstance.html" text="DmnModelInstance" >}}.
...
In addition to parsing all contained decisions of a [decision requirements graph]({{< relref "/reference/dmn/drg/_index.md" >}}) (DRG), the DMN engine can also parse the DRG itself from an `InputStream` or a `DmnModelInstance`.
...
It is possible to check if a parsed decision is implemented as [decision table] by using the method {{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/DmnDecision.html#isDecisionTable()" text="isDecisionTable()" >}}.
...
To evaluate (or "execute") a decision, either pass an already transformed {{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/DmnDecision.html" text="DmnDecision" >}} or use a DMN model instance or input stream in combination with a decision key.
...
The evaluation of a DMN decision returns a {{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/DmnDecisionResult.html"
...
{{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/DmnEngine.html##evaluateDecisionTable(org.finos.fluxnova.bpm.dmn.engine.DmnDecision, java.util.Map)"
text="evaluateDecisionTable()" >}} method if it is implemented as [decision table]. In this case, evaluation returns a {{< javadocref page="org/finos/fluxnova/bpm/dmn/engine/DmnDecisionTableResult.html" text="DmnDecisionTableResult" >}} which is semantically equal and provides the same methods as a
`DmnDecisionResult`.
...
[decision requirements graph]: {{< relref "/reference/dmn/drg/_index.md" >}}
...
[hit policy]: {{< relref "/reference/dmn/decision-table/hit-policy.md" >}}
[COLLECT]: {{< relref "/reference/dmn/decision-table/hit-policy.md#collect-hit-policy" >}}
[RULE ORDER]: {{< relref "/reference/dmn/decision-table/hit-policy.md#rule-order-hit-policy" >}}
