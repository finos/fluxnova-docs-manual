...
* **Operation Type**: The name of the performed operation. Available operation types are listed in the interface {{< javadocref page="org/finos/fluxnova/bpm/engine/history/UserOperationLogEntry.html" text="org.finos.fluxnova.bpm.engine.history.UserOperationLogEntry" >}}. Note that one operation can consist of multiple types, for example a cascading API operation is one user operation, but is split into multiple types of operations.
* **Entity Type**: An identifier of the type of the entity that was addressed by the operation. Available entity types are listed in the class {{< javadocref page="org/finos/fluxnova/bpm/engine/EntityTypes.html" text="org.finos.fluxnova.bpm.engine.EntityTypes" >}}. Like the operation type, one operation may address more than one type of entity.
* **Category**: The name of the category the operation is associated with. Available categories are listed in the interface {{< javadocref page="org/finos/fluxnova/bpm/engine/history/UserOperationLogEntry.html" text="org.finos.fluxnova.bpm.engine.history.UserOperationLogEntry" >}}. For example, all task related runtime operations like claiming and completing tasks fall into the category {{< javadocref page="org/finos/fluxnova/bpm/engine/history/UserOperationLogEntry.html#CATEGORY_TASK_WORKER" text="TaskWorker" >}}.
...
[op-log-set-annotation-instance-mod]: {{< relref "/user-guide/process-engine/process-instance-modification.md#annotation" >}}