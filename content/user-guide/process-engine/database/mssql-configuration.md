...
Microsoft SQL Server or Microsoft Azure SQL databases with Fluxnova. It provides guides
on:
...
* How Fluxnova supports Azure SQL.
* How to configure a database on Azure SQL to be supported by Fluxnova.
...
# Fluxnova support for Azure SQL
...
## Azure SQL compatibility levels supported by Fluxnova
...
Fluxnova supports the *Database Compatibility Level* values of the currently supported Microsoft 
SQL Server versions documented in our [Supported Database Products section]({{< relref "/introduction/supported-environments.md#supported-database-products" >}}).
...
behavior unsupported by Fluxnova.
