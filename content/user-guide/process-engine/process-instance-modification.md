...
runtimeService.createProcessInstanceModification(processInstanceId)
  ...
  .execute();
```
It will be visible in [User Operation Log]({{< relref "/user-guide/process-engine/history/user-operation-log.md#annotation-of-user-operation-logs" >}}) for the performed modification.
