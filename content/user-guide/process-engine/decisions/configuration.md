...
Follow the [instructions]({{< relref "/user-guide/process-engine/process-engine-bootstrapping.md#configure-process-engine-using-spring-xml" >}}) to create a base `fluxnova.cfg.xml` XML configuration for the process engine. 
