...
In addition to the decision definitions, the [decision requirements graph]({{< relref "/reference/dmn/drg/_index.md" >}}) (i.e., the `definitions` element in the XML) of a deployed DMN resource is transformed into a *Decision Requirements Definition*. It has, among others, these attributes:
...
[Process Application]: {{< relref "/user-guide/process-applications/_index.md" >}}
