...
[camunda:errorEventDefinition]({{< relref "/reference/bpmn20/custom-extensions/extension-elements.md#erroreventdefinition" >}})
...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Available during an external task context activity (e.g. in <a href="{{< relref "/reference/bpmn20/custom-extensions/extension-elements.md#erroreventdefinition" >}}">camunda:errorEventDefinition</a> expressions).</td>
    </tr>
    <tr>
