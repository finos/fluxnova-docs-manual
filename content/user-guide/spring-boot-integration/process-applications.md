...
By default, the fluxnova-spring-boot-starter is configured to use the `SpringProcessEngineConfiguration` auto deployment feature.
...
Some configuration can be done via Spring Boot configuration parameters. Check [the list of currently available parameters]({{<relref "/user-guide/spring-boot-integration/configuration.md#fluxnova-bpm-application">}}). 
