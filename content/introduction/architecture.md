...
See the section on [third-party libraries]({{< relref "/introduction/third-party-libraries/_index.md" >}}).
...
* [JAX-RS](https://jakarta.ee/specifications/restful-ws/) based Rest API
