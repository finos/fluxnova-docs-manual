...
menu:
  main:
    name: "BPMN"
    identifier: "fluxnova-modeler-bpmn"
    parent: "modeler"
...
To start modeling, create a new BPMN 2.0 diagram for the Fluxnova Platform by selecting **Create diagram > Create new BPMN diagram (Fluxnova Platform)** in the top-level menu.
...
The Fluxnova Modeler covers all BPMN 2.0 elements for modeling processes and collaborations.
